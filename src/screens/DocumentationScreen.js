...
const s = StyleSheet.create({
  ...
  sectionPills: { flexDirection: 'row', gap: 8, padding: tSpacing.md, paddingBottom: 0 },
  sectionPill: {
    flex: 1, paddingVertical: 8, borderRadius: tRadius.full,
    borderWidth: 1, borderColor: tColors.border,
    alignItems: 'center', backgroundColor: tColors.card,
  },
  sectionPillActive: { backgroundColor: tColors.student.primary, borderColor: tColors.student.primary },
  sectionPillText: { fontSize: 12, color: tColors.textSecondary, fontWeight: typography.semibold },
  sectionPillTextActive: { color: '#fff' },

  createBtn: {
    margin: tSpacing.md, marginBottom: 0,
    backgroundColor: tColors.student.primary,
    borderRadius: tRadius.md, paddingVertical: 12,
    alignItems: 'center',
  },
  createBtnText: { color: '#fff', fontSize: 14, fontWeight: typography.bold },

  listHeader: {
    fontSize: typography.lg, color: tColors.textPrimary, letterSpacing: 0.8, fontWeight: typography.bold,
    marginHorizontal: tSpacing.md, marginTop: tSpacing.base, marginBottom: tSpacing.sm,
  },
  emptyText: {
    fontSize: 13, color: tColors.textTertiary, marginHorizontal: tSpacing.md,
    marginBottom: tSpacing.sm, fontStyle: 'italic',
  },
  ...
  pendingCard: { borderColor: tColors.warning, backgroundColor: tColors.warningDim },
  docCardTop: { flexDirection: 'row', alignItems: 'flex-start', gap: tSpacing.sm, marginBottom: 6 },
  docTitle: { fontSize: 14, fontWeight: typography.bold, color: tColors.textPrimary, marginBottom: 2 },
  docMeta: { fontSize: 11, color: tColors.textSecondary, marginBottom: 2 },
  docSnippet: { fontSize: 12, color: tColors.textSecondary, fontStyle: 'italic', marginTop: 4, marginBottom: 4 },
  rejectionText: { fontSize: 11, color: tColors.error, marginTop: 4, marginBottom: 4 },

  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: tRadius.full, borderWidth: 1 },
  badgeText: { fontSize: 10, fontWeight: typography.semibold },

  docxBtn: {
    borderWidth: 1, borderColor: tColors.student.primary, borderRadius: tRadius.sm,
    paddingHorizontal: 12, paddingVertical: 5, alignSelf: 'flex-start',
    marginTop: 8,
  },
  docxBtnText: { fontSize: 11, color: tColors.student.primary, fontWeight: typography.semibold },

  approvalRow: { flexDirection: 'row', gap: 8, marginTop: tSpacing.sm },
  approveBtn: {
    flex: 1, backgroundColor: tColors.successDim, borderWidth: 1, borderColor: tColors.success,
    borderRadius: tRadius.sm, paddingVertical: 7, alignItems: 'center',
  },
  approveBtnText: { fontSize: 12, color: tColors.success, fontWeight: typography.bold },
  rejectBtn: {
    flex: 1, backgroundColor: tColors.errorDim, borderWidth: 1, borderColor: tColors.error,
    borderRadius: tRadius.sm, paddingVertical: 7, alignItems: 'center',
  },
  rejectBtnText: { fontSize: 12, color: tColors.error, fontWeight: typography.bold },
  cancelBtn: {
    flex: 1, backgroundColor: tColors.card, borderWidth: 1, borderColor: tColors.border,
    borderRadius: tRadius.sm, paddingVertical: 7, alignItems: 'center',
  },
  cancelBtnText: { fontSize: 12, color: tColors.textSecondary, fontWeight: typography.semibold },
  ...
  fieldLabel: {
    ...
    fontWeight: typography.bold, marginBottom: 5, marginTop: tSpacing.sm,
  },
  fieldInput: {
  ...
  addPointBtnText: { fontSize: 11, color: tColors.student.primary, fontWeight: typography.semibold },

  budgetTable: {
    borderWidth: 1, borderColor: tColors.border, borderRadius: tRadius.md,
    overflow: 'hidden', marginBottom: 6,
  },
  budgetRow: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: tColors.border },
  budgetHeader: { backgroundColor: tColors.bg },
  budgetHeaderText: { fontSize: 10, fontWeight: typography.bold, color: tColors.textSecondary, paddingHorizontal: 10, paddingVertical: 6 },
  ...
  clubPill: {
    ...
    borderRadius: tRadius.full, borderWidth: 1, borderColor: tColors.border,
    backgroundColor: tColors.bg,
  },
  clubPillActive: { backgroundColor: tColors.student.primary, borderColor: tColors.student.primary },
  clubPillText: { fontSize: 11, color: tColors.textSecondary, fontWeight: typography.medium },
  clubPillTextActive: { color: '#fff' },

  modePill: {
    flex: 1, paddingVertical: 6, borderRadius: tRadius.sm,
    borderWidth: 1, borderColor: tColors.border, alignItems: 'center',
    backgroundColor: tColors.bg,
  },
  modePillActive: { backgroundColor: tColors.student.primary, borderColor: tColors.student.primary },
  modePillText: { fontSize: 12, color: tColors.textSecondary, fontWeight: typography.medium },
  ...
  aiGenerateBtn: {
    ...
    borderRadius: tRadius.md, paddingVertical: 10,
    alignItems: 'center', marginBottom: tSpacing.md,
    backgroundColor: tColors.student.primary + '12',
  },
  aiGenerateBtnText: { fontSize: 13, color: tColors.student.primary, fontWeight: typography.semibold },
  aiDisclaimer: { fontSize: 11, color: tColors.textTertiary, lineHeight: 16, marginBottom: tSpacing.md, textAlign: 'center' },

  // AI modal
  aiModalBox: {
    backgroundColor: tColors.card, borderRadius: tRadius.lg,
    borderWidth: 1, borderColor: tColors.border,
    padding: tSpacing.base, width: '100%', maxWidth: 420,
  },
  aiModeBtn: {
    flex: 1, paddingVertical: 9, borderRadius: tRadius.sm,
    borderWidth: 1, borderColor: tColors.border,
    alignItems: 'center', backgroundColor: tColors.bg,
  },
  aiModeBtnActive: { backgroundColor: tColors.student.primary, borderColor: tColors.student.primary },
  aiModeBtnText: { fontSize: 11, color: tColors.textSecondary, fontWeight: typography.medium },
  aiModeBtnTextActive: { color: '#fff' },
  uploadPosterBtn: {
    borderWidth: 1.5, borderStyle: 'dashed', borderColor: tColors.student.primary,
    borderRadius: tRadius.md, paddingVertical: 16,
    alignItems: 'center', backgroundColor: tColors.student.primary + '08',
    marginBottom: tSpacing.sm,
  },
  uploadPosterBtnText: { fontSize: 12, color: tColors.student.primary, fontWeight: typography.medium },

  // Small modal (reject reason)
  smallModalOverlay: {
    flex: 1, justifyContent: 'center', alignItems: 'center',
    backgroundColor: 'rgba(0,0,0,0.6)', padding: tSpacing.base,
  },
  smallModalBox: {
    backgroundColor: tColors.card, borderRadius: tRadius.lg,
    borderWidth: 1, borderColor: tColors.border,
    padding: tSpacing.base, width: '100%',
  },
  smallModalTitle: { fontSize: 15, fontWeight: typography.bold, color: tColors.textPrimary, marginBottom: 6 },
  smallModalSub: { fontSize: 12, color: tColors.textSecondary, marginBottom: tSpacing.sm },
});
