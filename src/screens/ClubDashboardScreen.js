...
const styles = StyleSheet.create({
  ...
  bottomNavLabel: { fontSize: 9, color: colors.textTertiary, ...font.medium },
  scroll: { flex: 1 },
  ...
  backIcon: { color: '#fff', fontSize: 22, fontWeight: '700', marginTop: -2 },
  headerContent: { alignItems: 'center', gap: 4 },
  headerEmoji: { fontSize: 44 },
  headerName: { fontSize: 24, ...font.bold, color: '#fff', marginTop: 6 },
  headerFull: { fontSize: 12, color: 'rgba(255,255,255,0.75)', textAlign: 'center', paddingHorizontal: spacing.xl },
  roleBadge: {
    marginTop: 10, borderWidth: 1, borderRadius: radius.full,
    paddingHorizontal: 14, paddingVertical: 4,
  },
  roleText: { fontSize: 11, ...font.bold, letterSpacing: 0.8 },
  ...
  statVal: { fontSize: 18, ...font.bold, color: colors.textPrimary },
  ...
  sectionLabel: { fontSize: 11, ...font.bold, color: colors.textSecondary, letterSpacing: 0.8 },
  addBtn: {
    backgroundColor: colors.primaryLight, borderWidth: 1, borderColor: colors.primary,
    borderRadius: radius.full, paddingHorizontal: 10, paddingVertical: 4,
  },
  addBtnText: { fontSize: 11, color: colors.primary, ...font.semibold },
  seeAll: { fontSize: 12, color: colors.primary, ...font.semibold },
  ...
  eventTitle: { fontSize: 13, ...font.bold, color: colors.textPrimary, marginBottom: 4 },
  eventMeta: { fontSize: 11, color: colors.textSecondary, marginBottom: 4 },
  eventDesc: { fontSize: 11, color: colors.textTertiary, lineHeight: 16 },
  ...
  memberAbbr: { fontSize: 12, ...font.bold },
  memberName: { fontSize: 10, ...font.semibold, color: colors.textPrimary, textAlign: 'center' },
  memberMeta: { fontSize: 9, color: colors.textTertiary, textAlign: 'center' },
  memberMoreChip: {
    width: 62, height: 62 + spacing.sm * 2 + 10 + 9 + 3,
    alignItems: 'center', justifyContent: 'center',
    backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border,
    borderRadius: radius.md,
  },
  memberMoreText: { fontSize: 13, ...font.bold, color: colors.primary },
  ...
  wingCardHeader: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: 4 },
  wingDot: { width: 8, height: 8, borderRadius: 4, flexShrink: 0 },
  wingName: { fontSize: 13, ...font.bold, color: colors.textPrimary, flex: 1 },
  wingResp: { fontSize: 12, color: colors.textSecondary, lineHeight: 18, marginTop: 4 },
  wingMemberBadge: { borderRadius: 20, paddingHorizontal: 8, paddingVertical: 2 },
  wingMemberBadgeText: { fontSize: 11, ...font.semibold },
  wingTapHint: { fontSize: 11, color: colors.textTertiary, marginTop: 6 },
  wingPickerHint: { fontSize: 12, color: colors.textSecondary, marginBottom: spacing.sm },
  wingPickerOption: {
    flexDirection: 'row', alignItems: 'center', gap: spacing.sm,
    backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border,
    borderRadius: radius.sm, padding: spacing.md, marginBottom: spacing.sm,
  },
  wingPickerOptionSelected: { borderColor: colors.primary, backgroundColor: colors.primaryLight },
  wingPickerText: { fontSize: 14, color: colors.textPrimary, ...font.medium },
  wingPickerTextSelected: { color: colors.primary, ...font.bold },
  wingPickerSub: { fontSize: 11, color: colors.textSecondary, marginTop: 2 },

  // Event card action buttons row
  eventCardActions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 8 },
  trackerBtn: {
    alignSelf: 'flex-start',
    borderWidth: 1, borderColor: colors.border,
    borderRadius: radius.sm, paddingVertical: 5, paddingHorizontal: 10,
  },
  trackerBtnText: { fontSize: 12, color: colors.textSecondary, ...font.medium },
  nfaBtn: {
    alignSelf: 'flex-start',
    borderWidth: 1, borderColor: colors.primary,
    borderRadius: radius.sm, paddingVertical: 5, paddingHorizontal: 10,
  },
  nfaBtnText: { fontSize: 12, color: colors.primary, ...font.medium },

  // Tracker modal
  trackerHeader: {
    flexDirection: 'row', alignItems: 'center',
    paddingTop: 48, paddingBottom: 16, paddingHorizontal: spacing.md,
  },
  trackerHeaderTitle: { fontSize: 16, ...font.bold, color: '#fff' },
  trackerHeaderSub: { fontSize: 11, color: 'rgba(255,255,255,0.7)', marginTop: 2 },
  trackerProgressBox: {
    padding: spacing.lg,
    borderBottomWidth: 1, borderBottomColor: colors.border,
    backgroundColor: colors.card,
  },
  trackerProgressRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  trackerProgressLabel: { fontSize: 13, color: colors.textSecondary, ...font.medium },
  trackerProgressPct: { fontSize: 13, ...font.bold },
  ...
  stepCheckLocked: { backgroundColor: colors.card, borderColor: colors.border },
  stepCheckTick: { color: '#fff', fontSize: 14, ...font.bold },
  stepLockIcon: { fontSize: 10 },
  stepLabel: { fontSize: 14, color: colors.textPrimary, ...font.medium, lineHeight: 20, paddingTop: 6 },
  stepLabelDone: { textDecorationLine: 'line-through', color: colors.textTertiary },
  stepLabelLocked: { color: colors.textTertiary },
  stepActivePill: { fontSize: 11, ...font.semibold, marginTop: 2 },
  stepDelete: { paddingTop: 6, paddingLeft: spacing.sm },
  ...
  undoToastText: { color: colors.bg, fontSize: 13, ...font.medium },
  undoToastBtn: { color: colors.primary, fontSize: 13, ...font.bold },
  ...
  noticeCardTop: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm },
  noticeTitle: { flex: 1, fontSize: 13, ...font.semibold, color: colors.textPrimary },
  noticeBody: { fontSize: 12, color: colors.textSecondary, lineHeight: 18, marginTop: 4 },
  noticeMeta: { fontSize: 10, color: colors.textTertiary, marginTop: spacing.xs },
  ...
  rpAvatarText: { fontSize: 14, ...font.bold },
  rpName: { fontSize: 13, ...font.bold, color: colors.textPrimary },
  rpMeta: { fontSize: 11, color: colors.textSecondary, marginTop: 2 },
  rpEvent: { fontSize: 11, color: colors.primary, marginTop: 3 },
  rpContact: { fontSize: 11, color: colors.textSecondary, marginTop: 2 },

  deleteIcon: {
    padding: 4, flexShrink: 0,
  },
  deleteIconText: { fontSize: 12, color: colors.textTertiary },
  ...
  memberRoleText: { fontSize: 11, color: colors.primary, ...font.semibold, marginTop: 1 },
  memberNoRole: { fontSize: 11, color: colors.textTertiary, marginTop: 1 },
  editRoleBtn: {
    backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border,
    borderRadius: radius.full, paddingHorizontal: 10, paddingVertical: 4,
  },
  editRoleBtnText: { fontSize: 11, color: colors.textSecondary, ...font.semibold },
  showMoreBtn: {
    paddingVertical: 12, alignItems: 'center',
  },
  showMoreText: { fontSize: 12, color: colors.primary, ...font.semibold },
  clearRoleBtn: { alignItems: 'center', paddingVertical: 10, marginTop: 4 },
  clearRoleBtnText: { fontSize: 13, color: colors.red },
  roleList: { maxHeight: 260, marginBottom: 4 },
  roleOption: {
    flexDirection: 'row', alignItems: 'center',
  ...
  roleOptionText: { flex: 1, fontSize: 14, color: colors.textPrimary, ...font.medium },
  roleOptionTextSelected: { color: colors.primary, ...font.bold },
  roleOptionCheck: { fontSize: 14, color: colors.primary, ...font.bold },
  ...
  memberRowName: { fontSize: 13, ...font.semibold, color: colors.textPrimary },
  memberRowMeta: { fontSize: 11, color: colors.textTertiary, marginTop: 1 },
  ...
  datePickerPlaceholder: { color: colors.textTertiary, fontSize: 14 },
  ...
  calMonthLabel: { fontSize: 16, ...font.bold, color: colors.textPrimary },
  calNavBtn: { padding: 6 },
  calNavBtnText: { fontSize: 22, color: colors.primary, lineHeight: 24 },
  calWeekRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 4 },
  calDayLabel: { width: 36, textAlign: 'center', fontSize: 11, ...font.bold, color: colors.textSecondary },
  ...
  calDaySelText: { color: '#fff', ...font.bold },
  calDayTodayText: { color: colors.primary, ...font.bold },
  ...
  eventReqCardTop: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm, marginBottom: 4 },
  eventReqName: { flex: 1, fontSize: 13, ...font.semibold, color: colors.textPrimary },
  eventReqStatusPill: {
    borderRadius: radius.full, borderWidth: 1,
    paddingHorizontal: 8, paddingVertical: 2, flexShrink: 0,
  },
  eventReqStatusText: { fontSize: 9, ...font.bold, letterSpacing: 0.4 },
  eventReqMeta: { fontSize: 11, color: colors.textTertiary },
  ...
  teamDashBannerTitle: { fontSize: 14, ...font.bold },
  teamDashBannerSub: { fontSize: 11, color: colors.textSecondary, marginTop: 2 },
  teamDashBannerArrow: { fontSize: 26, ...font.bold },

  headerLogo: { width: 72, height: 72, borderRadius: 16, borderWidth: 2, borderColor: 'rgba(255,255,255,0.6)' },
  uploadLogoBtn: {
    marginTop: 10, paddingHorizontal: 14, paddingVertical: 5,
    backgroundColor: 'rgba(0,0,0,0.25)', borderRadius: radius.full,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.4)',
  },
  uploadLogoBtnText: { fontSize: 12, color: '#fff', ...font.semibold },
  logoErrorText: { fontSize: 11, color: '#FFD0D0', marginTop: 4 },

  // Contribution Hours
  hoursSubLabel: {
    fontSize: 9, ...font.bold, color: colors.textTertiary,
  ...
  hourReqBtnText: { fontSize: 12, ...font.bold },
  hourLeaderRow: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    paddingVertical: spacing.sm,
    borderBottomWidth: 1, borderBottomColor: colors.border,
  },
  hourLeaderRank: { fontSize: 11, ...font.bold, color: colors.textTertiary, width: 22 },
  hourAmount: { fontSize: 14, ...font.bold, color: colors.textPrimary, minWidth: 36, textAlign: 'right' },
  setHoursBtn: {
    backgroundColor: colors.primary + '22', borderRadius: radius.sm,
    paddingHorizontal: 10, paddingVertical: 5,
    borderWidth: 1, borderColor: colors.primary,
  },
  setHoursBtnText: { fontSize: 11, ...font.bold, color: colors.primary },
  ...
  adminActionTitle: { fontSize: 13, ...font.semibold, color: colors.textPrimary },
  adminActionDesc: { fontSize: 11, color: colors.textSecondary, marginTop: 1 },
  adminActionArrow: { fontSize: 20, color: colors.textTertiary },
  deleteClubBtn: {
    flexDirection: 'row', alignItems: 'center', gap: spacing.sm,
    backgroundColor: colors.redLight, borderWidth: 1, borderColor: colors.red,
    borderRadius: radius.md, padding: spacing.md, marginBottom: spacing.sm,
  },
  deleteClubTitle: { fontSize: 13, ...font.semibold, color: colors.red },
  ...
  joinReqAvatarText: { fontSize: 12, ...font.bold, color: colors.primary },
  joinReqName: { fontSize: 13, ...font.semibold, color: colors.textPrimary },
  joinReqMeta: { fontSize: 11, color: colors.textSecondary },
  joinReqMessage: { fontSize: 12, color: colors.textTertiary, fontStyle: 'italic', marginBottom: spacing.sm },
